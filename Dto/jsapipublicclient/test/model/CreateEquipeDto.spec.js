...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerSportApplicatiohOpenApi30.CreateEquipeDto();
  });
  ...
  describe('CreateEquipeDto', function() {
    it('should create an instance of CreateEquipeDto', function() {
      // uncomment below and update the code to test CreateEquipeDto
      //var instance = new SwaggerSportApplicatiohOpenApi30.CreateEquipeDto();
      //expect(instance).to.be.a(SwaggerSportApplicatiohOpenApi30.CreateEquipeDto);
    });
