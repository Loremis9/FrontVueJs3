...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerSportApplicatiohOpenApi30.CreateJoueurDto();
  });
  ...
  describe('CreateJoueurDto', function() {
    it('should create an instance of CreateJoueurDto', function() {
      // uncomment below and update the code to test CreateJoueurDto
      //var instance = new SwaggerSportApplicatiohOpenApi30.CreateJoueurDto();
      //expect(instance).to.be.a(SwaggerSportApplicatiohOpenApi30.CreateJoueurDto);
    });
    ...
    it('should have the property posteId (base name: "PosteId")', function() {
      // uncomment below and update the code to test the property posteId
      //var instance = new SwaggerSportApplicatiohOpenApi30.CreateJoueurDto();
      //expect(instance).to.be();
    });
