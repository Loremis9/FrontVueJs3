...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerSportApplicatiohOpenApi30.DivisionDto();
  });
  ...
  describe('DivisionDto', function() {
    it('should create an instance of DivisionDto', function() {
      // uncomment below and update the code to test DivisionDto
      //var instance = new SwaggerSportApplicatiohOpenApi30.DivisionDto();
      //expect(instance).to.be.a(SwaggerSportApplicatiohOpenApi30.DivisionDto);
    });
