...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerSportApplicatiohOpenApi30.PosteDto();
  });
  ...
  describe('PosteDto', function() {
    it('should create an instance of PosteDto', function() {
      // uncomment below and update the code to test PosteDto
      //var instance = new SwaggerSportApplicatiohOpenApi30.PosteDto();
      //expect(instance).to.be.a(SwaggerSportApplicatiohOpenApi30.PosteDto);
    });
