...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerSportApplicatiohOpenApi30.CreateEquipeAdverseDto();
  });
  ...
  describe('CreateEquipeAdverseDto', function() {
    it('should create an instance of CreateEquipeAdverseDto', function() {
      // uncomment below and update the code to test CreateEquipeAdverseDto
      //var instance = new SwaggerSportApplicatiohOpenApi30.CreateEquipeAdverseDto();
      //expect(instance).to.be.a(SwaggerSportApplicatiohOpenApi30.CreateEquipeAdverseDto);
    });
