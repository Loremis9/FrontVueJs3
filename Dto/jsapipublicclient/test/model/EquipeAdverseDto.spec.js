...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerSportApplicatiohOpenApi30.EquipeAdverseDto();
  });
  ...
  describe('EquipeAdverseDto', function() {
    it('should create an instance of EquipeAdverseDto', function() {
      // uncomment below and update the code to test EquipeAdverseDto
      //var instance = new SwaggerSportApplicatiohOpenApi30.EquipeAdverseDto();
      //expect(instance).to.be.a(SwaggerSportApplicatiohOpenApi30.EquipeAdverseDto);
    });
